...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const newSujetAiSuggestionInput = document.getElementById('new-sujet-ai-suggestion');
    ...
    function openNewSujetModal() {
        ...
        newSujetAiSuggestionInput.value = '';
    ...
    async function createNewSujet() {
        ...
        const aiSuggestion = newSujetAiSuggestionInput.value.trim();
        ...
        try {
            ...
            if (result.status === 'success') {
                ...
                if (result.sujet && result.sujet.id) {
                    ...
                    // Update status
                    updateStatus('Sujet created successfully');
                }
            } else {
                alert(`Error creating sujet: ${result.message || 'Unknown error'}`);
            }
        } catch (error) {
            console.error('Error creating sujet:', error);
            alert('Failed to create sujet. Please try again.');
        }
    }
